...
- [Circle App Kit browser integration](circle-appkit-browser.md) — Buffer polyfill required; vite-plugin-node-polyfills + clear .vite cache; wagmi adapter pattern
